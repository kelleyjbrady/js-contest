...
# 2. Stage the Data
echo -e "\n[*] Phase 2: SKIPPED - Tensors already safely in orbit."
# gcloud storage cp embed_layer_15.pt trigger_layer_15.pt gs://${BUCKET_NAME}/

# 3. Build and Push the Container (This will take seconds due to cache!)
echo -e "\n[*] Phase 3: Building Docker image..."
docker build -t $IMAGE_NAME .

echo -e "\n[*] Phase 4: Pushing lightweight code updates to GCR..."
